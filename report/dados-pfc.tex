...
%%% TITULO DO PFC
\titulo{Ferramenta de classificação de questões para auxílio ao aprendizado}

%%% DATA DA APRESENTAÇÃO (formato {dd}{Mmmmm}{aaaa})
\datadefesa{5}{Outubro}{2018}
...
% ---
\membrobancaI{Maj.}{Julio Cesar Duarte}{D}{do IME}
\membrobancaII{P}{Ronaldo Ribeiro Goldschmidt}{D}{do IME}
